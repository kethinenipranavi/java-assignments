...
import com.capgemini.exceptionhandling.model.CurrentBankAccount;
...
public class CurrentBankAccountTest {
	...
	@Before
	public void setUp() {
		currentAccount = new CurrentBankAccount(101, "pranavi", 24000, 20000);
	}
	...
	public void tesBankAccountIsCreatedWithParametrizedConstructor() {
		...
		assertEquals("pranavi", currentAccount.getAccountHolderName());
