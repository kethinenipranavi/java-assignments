...
import com.capgemini.exceptionhandling.model.BankAccount;
...
public class BankAccountTest {
	...
	@Before
	public void setUp() {
		account = new BankAccount(101, "pranavi", "Saving", 24000);
	}
	...
	public void tesBankAccountIsCreatedWithParametrizedConstructor() {
		BankAccount account = new BankAccount(101, "pranavi", "Saving", 44000);
		assertNotNull(account);
