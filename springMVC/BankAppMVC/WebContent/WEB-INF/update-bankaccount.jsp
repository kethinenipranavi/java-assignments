...
<form style="margin-top:50px;"action="update account.do" method="post">
  <div class="container">
        <h1>ICICI Bank</h1>
        <label for="Account Id"><b>Account Id</b></label>
        <input type="number"name="Account Id" required>
    
        
<br><br>
<hr>
<p> <a href="#"></a>.<center><input type="submit" class="btn btn-primary" value="Get Details">
</center>
