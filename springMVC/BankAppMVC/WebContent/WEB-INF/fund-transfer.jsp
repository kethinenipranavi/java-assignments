...
<body>
	...
	<form style="margin-top: 50px;" action="FundTransfer.do" method="post">
		<div class="container">
			<h1>ICICI Bank</h1>
			<label for="Sender Account Id"><b>Sender Account Id</b></label> <input
				type="number" name="senderId" required /> <label
				for="Receiver Account Id"><b>Receiver Account Id</b></label> <input
				type="number" name="receiverId" required /> <label for="Amount"><b>Amount</b></label>
