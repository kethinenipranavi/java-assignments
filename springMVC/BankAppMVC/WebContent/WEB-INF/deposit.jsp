...
<body>
	...
	<form style="margin-top: 50px;" action="Deposit.do" method="post">
		<div class="container">
			<h1>ICICI Bank</h1>
			<label for="Account Id"><b>Account Number</b></label> <input
				type="text" name="Account Id" required> <label for="Amount"><b>Amount</b></label>
